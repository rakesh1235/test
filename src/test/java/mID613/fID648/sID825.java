...
public class tc1 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new HerokuPage(driver).username1,"username1");
        ...
        try
        {
            actions.EnterData(new HerokuPage(driver).password2,"password2");
