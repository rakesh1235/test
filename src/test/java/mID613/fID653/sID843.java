...
public class qwqwere extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new orenge(driver).txtUsername21,"txtUsername21Value");
        ...
        try
        {
            actions.EnterData(new orenge(driver).Submit8,"Submit8Value");
        ...
        try
        {
            actions.EnterData(new orenge(driver).txtPassword15,"txtPassword15Value");
