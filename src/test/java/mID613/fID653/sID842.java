...
public class sdsd extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new Heroku12(driver).username1,"username1Value");
        ...
        try
        {
            actions.EnterData(new Heroku12(driver).password2,"password2Value");
        ...
        try
        {
            actions.Click(new Heroku12(driver).buttonobj3);
