...
public class newscr21 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new testPahe12(driver).username1,"username1Value");
        ...
        try
        {
            actions.EnterData(new testPahe12(driver).password5,"password5Value");
        ...
        try
        {
            actions.Click(new testPahe12(driver).buttonobj3);
